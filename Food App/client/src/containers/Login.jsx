        ...
        <div className={`container ${rightPanelActive ? 'right-panel-active' : ''}`} id="login-container">
          <div className="form-container sign-up-container">
            <form action="#">
              ...
              <div className="social-container">
                <button type='button' onClick={loginWithGoogle} className="social-google"><FcGoogle /> Sign Up With Google</button>
              </div>
              ...
              <input
                ...
                required
              />
              <button onClick={signUpWithEmailPass} className="sign" type="button">Sign Up</button>
            </form>
          </div>
          ...
          <div className="form-container sign-in-container">
            <form action="#">
              ...
              <div className="social-container">
                <button type='button' onClick={loginWithGoogle} className="social-google"><FcGoogle /> Sign In With Google</button>
              </div>
              ...
              <button onClick={signInWithEmailpass} className="sign" type="button">Sign In</button>
            </form>
          </div>
