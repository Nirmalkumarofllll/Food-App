...
const FilterSection = () => {
  ...
  return (
    <motion.div  className="w-full flex items-start justify-start flex-col">
      ...
      <div className="w-full flex-wrap pt-6 flex items-center justify-center gap-6 py-8">
        {statuses &&
          statuses.map((data, i) => (
            <FilterCard
              data={data}
...
export const FilterCard = ({ data, index, category, setCategory }) => {
  return (
    <motion.div
      ...
      } hover:bg-red-400 shadow-md flex flex-col items-center justify-center gap-4`}
    >
      <div
